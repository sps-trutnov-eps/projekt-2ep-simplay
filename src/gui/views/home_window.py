...
class HomeView(object):        
    def setupUi(self, MainWindow):        
        ...
        icon = QIcon()
        icon.addFile(u":../assets/clock.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":../assets/menu.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":../assets/users.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":../assets/plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.rmvGameBtn.setMinimumSize(QSize(150, 30))
